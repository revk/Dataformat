...
char *
dataformat_postcode_n (char *res, size_t len, const char *p, int space)
{
  if (!p)
    return NULL;
...
char *
dataformat_telephone_n (char *res, size_t len, const char *p, int space, int uktel)
{
  if (!p)
    return NULL;
  unsigned int f = 0, t = 0;
...
char *
dataformat_email_n (char *target, size_t len, const char *source)
...
char *
dataformat_domain_n (char *target, size_t len, const char *source)
...
char *
dataformat_token_n (char *target, size_t len, const char *source, const char *chars)
...
char *
dataformat_posttown_n (char *target, size_t len, const char *source)
...
char *
dataformat_name_n (char *target, size_t len, const char *source)
